...
class Summary_buysell_by_month extends Bks_Controller {
    ...
    {   
        ...
        $html_header .= '<br>' . 'Summary Buy and Sell Period ' . namabulan(sprintf("%02d", $this->tr_month)) . ' ' . sprintf("%04d", $this->tr_year) . '</br><br></br><br></br>';        
        ...
        $pdf->Output('Summary Buy and Sell Period ' . namabulan(sprintf("%02d", $this->tr_month)) . ' ' . sprintf("%04d", $this->tr_year) .'.pdf','I');
    }
    ...
    function excel(){
        ...
        $this->excel->setActiveSheetIndex(0)->setCellValue('A3', 'Summary Buy and Sell Period ' . namabulan(sprintf("%02d", $this->tr_month)) . ' ' . sprintf("%04d", $this->tr_year)  ); 
        ...
        $filename = 'Summary Buy and Sell Period ' . namabulan(sprintf("%02d", $this->tr_month)) . ' ' . sprintf("%04d", $this->tr_year)  ;
